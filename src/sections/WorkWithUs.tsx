      ...
      <div className="relative h-[720px] bg-[url('cozy-living-room.jpeg')] bg-cover bg-center">
        ...
        <div className="relative font-serif z-10 flex flex-col justify-between h-full text-white">
          <div className="flex flex-col gap-12 justify-center mb-14 items-center h-full">
            <h1 className="text-7xl ">Work With Us</h1>
            <p className="max-w-2xl font-medium text-xl text-center">
            ...
            <button className="text-xl rounded-md px-8 py-3 font-medium uppercase border-2 hover:bg-gray-50 hover:text-gray-800 cursor-pointer transition-colors duration-200 border-white">
              Contact Us
            </button>
          </div>
        </div>
